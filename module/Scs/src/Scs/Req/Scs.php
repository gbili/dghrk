...
class Scs extends \Gbili\Db\Req\AbstractReq
{
    public function loadKeyedFields(array $keys = array())
    {
        return array(
                ...
                'post_id' => 'p.id',
                'post_slug' => 'p.slug',
                'post_translated_id' => 'p.translated_id',
                'post_title' => 'pd.title',
    ...
    public function getBaseSqlString()
    {
        return 'SELECT ' . "\n"
            ...
            . ' FROM posts AS p ' . "\n"
                ...
                . ' LEFT JOIN gbilium__users AS u ON p.user_id = u.id ' . "\n"
                . ' LEFT JOIN post_datas AS pd ON p.data_id = pd.id ' . "\n"
                . ' LEFT JOIN gbilimem__medias AS m ON pd.media_id = m.id '  . "\n"
