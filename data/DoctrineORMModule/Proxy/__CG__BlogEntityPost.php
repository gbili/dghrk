...
class Post extends \Blog\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'translated', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'slug', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'uniqueslug', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'locale', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'data', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'category', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'categoryslug', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'user', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'lft', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'lvl', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'rgt', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'root', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'parent', '' . "\0" . 'Blog\\Entity\\Post' . "\0" . 'children');
        }
     ...
     * {@inheritDoc}
     */
    public function setTranslated(\Blog\Entity\Translated $translated = NULL)
    {
