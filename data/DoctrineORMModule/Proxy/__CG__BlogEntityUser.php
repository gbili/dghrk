 ...
 */
class UserData extends \Blog\Entity\UserData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blog\\Entity\\UserData' . "\0" . 'id', '' . "\0" . 'Blog\\Entity\\UserData' . "\0" . 'user', '' . "\0" . 'Blog\\Entity\\UserData' . "\0" . 'posts', '' . "\0" . 'Blog\\Entity\\UserData' . "\0" . 'categories', '' . "\0" . 'Blog\\Entity\\UserData' . "\0" . 'medias', '' . "\0" . 'Blog\\Entity\\UserData' . "\0" . 'dogs', '' . "\0" . 'Blog\\Entity\\UserData' . "\0" . 'profile');
        }
